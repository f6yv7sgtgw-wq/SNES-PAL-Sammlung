...
assert.match(indexHtml, /<title>Projekt SNES · v0\.3\.5\.2<\/title>/);
assert.match(corpus, /Projekt SNES/);
assert.match(corpus, /snes-pal-sammlung-baseline-0\.3\.4/);
assert.match(corpus, /v0\.3\.5\.2/);
...
assert.match(corpus, /snes-pal-sammlung-search-v0352/);

console.log(
  "Validated GitHub Pages artifact: Project SNES v0.3.5.2, condition-aware guide values, fresh search cache and compact mobile UI are present.",
);
